...
msbuild copyjs.targets /p:OutDir=..\tests\output\Databinding
msbuild copytemplates.targets /p:OutDir=..\tests\output\Databinding
msbuild copyxap.targets /p:ProjectName=Databinding /p:OutDir=..\tests\output\Databinding
..\bin\SL2JS.Compiler.exe "..\testsinput\Databinding\Bin\Debug\Databinding.dll" -OutputDirectory:..\tests\output\Databinding -IncludeDependencies:false
